        ...
        <a-row :gutter="48">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item label="发货状态">
              <a-select v-model="queryParam.delivery_state" placeholder="请选择" default-value="0" @change="onSelectChange">
                <a-select-option value="-1">全部</a-select-option>
                <a-select-option value="0">未发货</a-select-option>
                <a-select-option value="10">已发货</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
        </a-row>
...
export default {
  ...
  methods: {
    ...
    // },
    onSelectChange(){
      this.getOrders({order_code:this.queryParam.delivery_state});
    },
    toggleAdvanced() {
